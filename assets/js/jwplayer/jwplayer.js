			...
			623: function(t, e, n) {
				...
				var B = function(t) {
						...
						this.start = function(n) {
							var r = L(t, n),
								i = Promise.all([v(t), N(t), r, _(t), F(t), O(t), D(t)]),
			...
			8320: function(t, e, n) {
				...
				function d(t, e, n) {
					var i = t.getProviders(),
						...
						a = t.get("jwStart"),
						c = (0, r.Z)({}, e);
					if (c.preload = o(e.preload, u), c.allSources = v(c, t), c.sources = g(c.allSources, i), c.sources.length) return c.file = c.sources[0].file, c.feedData = n, c.starttime = -1 !== a && t.get("generateSEOMetadata") ? a : c.starttime,
						function(t) {
				...
				var r = n(8518),
					...
					u = function(t) {
						...
						return t.timestamps.forEach((function(t) {
							var r = t.time,
								o = Object.keys(t.title)[0],
								u = t.title[n] || t.title[i] || t.title[o];
							e.push({
								begin: r,
								text: u,
								cueType: "chapters"
